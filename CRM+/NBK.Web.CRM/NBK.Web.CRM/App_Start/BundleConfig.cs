    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/animate.css",
                      "~/Content/style.css",
                      "~/Content/plugins/pnotify/jquery.pnotify.default.css",
                      "~/Content/plugins/pnotify/jquery.pnotify.default.icons.css"));
            ...
            // Angular
            bundles.Add(new ScriptBundle("~/plugins/pnotify").Include(
